...
function getTagByChanson($uneChanson)
{
    try
    {
        ...
        $req = bindValue(':uneChanson', $uneChanson, PDO::PARAM_INT);
...
function AddTag($unTag,$uneChanson)
{
    try
    {
        ...
        $req = bindValue(':unTag', $unTag, PDO::PARAM_INT);
        $req = bindValue(':uneChanson', $uneChanson, PDO::PARAM_INT);
...
function MajTag($ancienTag,$nouveauTag,$uneChanson)
{
    try
    {
        ...
        $req = bindValue(':nouveauTag', $nouveauTag, PDO::PARAM_INT);
        $req = bindValue(':ancienTag', $ancienTag, PDO::PARAM_INT);
        $req = bindValue(':uneChanson', $uneChanson, PDO::PARAM_INT);
